...
export const seatContainerStyle = {
  flexDirection: 'row',
  margin: 5,
  justifyContent: 'space-evenly'
};
export const viewBorderStyle = {
...
export const instructionSeatLayout = {
  flexDirection: 'row',
  alignItems: 'center',
  justifyContent: 'space-evenly',
  marginHorizontal: 10
...
export const imgHeaderStyle = {
  height: '40%',
  width: '40%'
};
export const seatImageStyle = {
  height: 40,
  width: 40,
  marginRight: 5
};
export const seatNumberStyle = {
  textTransform: 'capitalize',
  marginRight: 5
};
export const imgBackgroundStyle = {
...
export const bookinmgSeatNumberStyle = {
  marginTop: -5,
  fontWeight: '500',
  fontSize: 8
};
export const blokcedSeatStyle = {
  height: '45%',
  width: '45%'
};
